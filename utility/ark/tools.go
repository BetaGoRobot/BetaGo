...
func CallFunction(ctx context.Context,
	argEvent *responses.FunctionCallArgumentsDoneEvent,
	meta *FunctionCallMeta, modelID, lastRespID string, f fcFunc,
) (resp *utils.ResponsesStreamReader, err error) {
...
var CallFunctionMap = map[string]fcFunc{
	ToolSearchHistory: HybridSearch,
}

// func SetActivity(ctx context.Context, meta *FunctionCallMeta, argStr string) (res any, err error) {
// 	args := &SetActivityArgs{}
// 	err = sonic.UnmarshalString(argStr, &args)
// 	if err != nil {
// 		return
// 	}
// 	res, err = history.SetActivity(ctx,
// 		history.SetActivityRequest{
// 			UserID: args.UserID,
// 			ChatID: meta.ChatID,
// 			Topics: args.Topics,
// 		})
