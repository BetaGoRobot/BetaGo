...
import (
	...
	betagovar "github.com/BetaGoRobot/BetaGo/consts"
	"github.com/BetaGoRobot/BetaGo/dal/neteaseapi"
	command_context "github.com/BetaGoRobot/BetaGo/handler/commandHandler/context"
...
func selfCheckInner() {
	...
	case <-betagovar.SelfCheckChan:
		logs.L.Info(context.Background(), "self check successful")
	default:
